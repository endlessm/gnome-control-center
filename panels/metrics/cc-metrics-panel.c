...
cc_metrics_panel_constructed (GObject *object)
{
  ...
  /* It would be clearer to use our own metrics_enabled property, but for this
   * purpose it is fine to treat the switch's state property as canonical. */
  g_object_bind_property (self->enable_metrics_switch, "state",
                          self->enable_metrics_switch, "active",

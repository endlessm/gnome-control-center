                                    ...
                                    NMConnection   *connection)
{
  ...
  hdy_action_row_set_subtitle (self->network_row, NULL);
  ...
  if (metered == NM_METERED_YES || metered == NM_METERED_GUESS_YES)
    hdy_action_row_set_subtitle (self->network_row, _("Limited data plan connection"));
  else
    hdy_action_row_set_subtitle (self->network_row, _("Unlimited data plan connection"));
}
  ...
  if (ap)
    {
      ...
      hdy_preferences_row_set_title (HDY_PREFERENCES_ROW (self->network_row), title);
    }
  else
    {
      hdy_preferences_row_set_title (HDY_PREFERENCES_ROW (self->network_row),

...
static void sync_initial_state_from_updater (CcInfoPanel *self);
...
cc_info_panel_init (CcInfoPanel *self)
{
  ...
  self->priv->client = udisks_client_new_sync (NULL, &error);
